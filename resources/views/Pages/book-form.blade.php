        ...
        <div class="ibox ">
            ...
            <div class="ibox-content">
                ...
                <form enctype="multipart/form-data"
                    action="{{ isset($data) ? route('books.update', $data->id) : route('books.store') }}" method="POST">
                    ...
                    <div class="form-group row"><label class="col-sm-2 col-form-label">Select Country</label>
                        ...
                        <div class="col-sm-10"><select class="form-control m-b" name="country_id">
                                @foreach ($countries as $c)
                                    <option value="{{ $c->id }}"
                                        {{ old('country_id', $data->country_id ?? '') == $c->id ? 'selected' : '' }}>
                                        {{ $c->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" name="amount" min="0" max="1000"
                                step="0.01" value="{{ old('amount', $data->amount ?? '') }}">
